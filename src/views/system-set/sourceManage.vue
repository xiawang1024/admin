    ...
    <div class="tool-bar clearfix">
      ...
      <el-popover placement="bottom-start" v-model="popoverVisible">
        <div style="text-align: right; margin: 0">
          <el-input :rows="2" v-model="folderName" style="margin-bottom:10px;" placeholder="请输入文件夹名称"></el-input>
    ...
    <el-table :data="sourceFileList" style="width: 100%">
      ...
      <el-table-column label="操作">
        <template slot-scope="scope">
          <el-button type="prime" @click="sync(scope.$index, scope.row)" title="同步资源文件到发布目录">同步</el-button>
