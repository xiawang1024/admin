<template>
  <div class="extendField-container">
    ...
    <el-table :data="extendFieldList" style="width: 100%">
      <el-table-column prop="id" label="编号"></el-table-column>
      <el-table-column prop="desc" label="所属栏目"></el-table-column>
      ...
      <el-table-column prop="default" label="预设内容"></el-table-column>
    ...
    <el-dialog title="添加发布平台" top="6vh" :visible.sync="addExtendFieldVisible">
      <el-form :model="extendFieldForm">
        <el-form-item label="编号">
          <el-input v-model="extendFieldForm.id"></el-input>
        </el-form-item>
        <el-form-item label="所属栏目">
          <el-input v-model="extendFieldForm.desc"></el-input>
        </el-form-item>
        <el-form-item label="显示名称">
          <el-input v-model="extendFieldForm.viewName"></el-input>
        </el-form-item>
        <el-form-item label="字段名称">
          <el-input v-model="extendFieldForm.fieldName"></el-input>
        </el-form-item>
        <el-form-item label="访问地址">
          <el-input v-model="extendFieldForm.required"></el-input>
        </el-form-item>
        <el-form-item label="类别">
          <el-input v-model="extendFieldForm.type"></el-input>
        </el-form-item>
        <el-form-item label="字段类型">
          <el-input v-model="extendFieldForm.fieldType"></el-input>
        </el-form-item>
    ...
    <el-dialog title="修改发布平台" top="6vh" :visible.sync="alterExtendFieldVisible">
      <el-form :model="extendFieldForm">
        <el-form-item label="编号">
          <el-input v-model="extendFieldForm.id"></el-input>
        </el-form-item>
