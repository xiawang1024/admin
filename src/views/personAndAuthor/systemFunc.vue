<template>
  <div class="systemFunc-container">
    ...
    <el-table :data="siteList" style="width: 100%">
      <el-table-column prop="mark" label="标示"></el-table-column>
      <el-table-column prop="desc" label="描述"></el-table-column>
      <el-table-column prop="name" label="名称"></el-table-column>
      <el-table-column prop="location" label="访问地址"></el-table-column>
      <el-table-column prop="controller" label="控制器"></el-table-column>
      <el-table-column prop="viewer" label="视图"></el-table-column>
    ...
    <el-dialog title="添加发布平台" top="6vh" :visible.sync="addSystemFuncVisible">
      <el-form :model="systemFuncForm">
        <el-form-item label="标示">
          <el-input v-model="systemFuncForm.mark"></el-input>
        </el-form-item>
        <el-form-item label="描述">
          <el-input v-model="systemFuncForm.desc"></el-input>
        </el-form-item>
        <el-form-item label="名称">
          <el-input v-model="systemFuncForm.name"></el-input>
        </el-form-item>
        <el-form-item label="访问地址">
          <el-input v-model="systemFuncForm.location"></el-input>
        </el-form-item>
        <el-form-item label="控制器">
          <el-input v-model="systemFuncForm.controller"></el-input>
        </el-form-item>
        <el-form-item label="视图">
          <el-input v-model="systemFuncForm.viewer"></el-input>
        </el-form-item>
        <el-form-item label="表达式">
          <el-input v-model="systemFuncForm.expression"></el-input>
        </el-form-item>
      </el-form>
    ...
    <el-dialog title="修改发布平台" top="6vh" :visible.sync="alterSystemFuncVisible">
      <el-form :model="systemFuncForm">
        <el-form-item label="标示">
          <el-input v-model="systemFuncForm.mark"></el-input>
        </el-form-item>
