<template>
  <div class="picturesAndAccessories-wrap">
    <p class="title">附件</p>
    <el-table :data="accessoryData" style="width: 100%">
    ...
    <p class="title">正文图片</p>
    <el-table :data="bodyImagesData" style="width: 100%">
      <el-table-column prop="title" label="文件"/>
      <el-table-column prop="belongColumn" label="信息"/>
      <el-table-column prop="releaseTime" label="自定义数据"/>
      <el-table-column prop="author" label="标题与描述"/>
    ...
    <p class="title">视频</p>
    <el-table :data="moviesData" style="width: 100%">
      <el-table-column prop="title" label="文件"/>
      <el-table-column prop="belongColumn" label="信息"/>
      <el-table-column prop="releaseTime" label="自定义数据"/>
      <el-table-column prop="author" label="标题与描述"/>
